<%@ Page Language="VB" MasterPageFile="~/CSBCAdminMasterPage.master" AutoEventWireup="false" CodeFile="ReportRefunds.aspx.vb" Inherits="ReportRefunds" title="Refunds Reports" %>
    ...
    <table style="width: 765px; height: 198px">
        <tr>
            <td align="center" rowspan="9" colspan="2" valign="top">
                &nbsp;<igtbl:UltraWebGrid ID="grdBatches" runat="server" Height="309px" Width="577px" style="left: -97px; top: 109px">
                    <Bands>
                        <igtbl:UltraGridBand>
                    ...
                    <DisplayLayout AllowColSizingDefault="Free" AllowSortingDefault="OnClient" BorderCollapseDefault="Separate"
                        ...
                        Name="grdBatches" NoDataMessage="No Refunds found" RowHeightDefault="20px" RowSelectorsDefault="No"
                        ...
                        <FrameStyle BackColor="Window" BorderColor="Navy" BorderStyle="None" BorderWidth="1px"
                            Font-Names="Arial" Font-Size="9pt" Height="309px" Width="577px">
                        </FrameStyle>
                        <Pager>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White"></BorderDetails>
            ...
            <td style="width: 107px; height: 26px" align="center">
                <asp:Button ID="btnPrint" runat="server" Text="View Report" Width="104px" /></td>
        </tr>
        <tr>
            <td align="center" style="width: 107px; height: 26px">
            </td>
