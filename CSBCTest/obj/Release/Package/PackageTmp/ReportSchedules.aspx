<%@ Page Language="VB" MasterPageFile="~/CSBCAdminMasterPage.master" AutoEventWireup="false" CodeFile="ReportSchedules.aspx.vb" Inherits="ReportSchedules" title="Schedules Reports" %>
            ...
            <td align="center" rowspan="9" colspan="2" valign="top">
                &nbsp;<igtbl:UltraWebGrid ID="grdDivisions" runat="server" Height="309px" Width="397px" style="left: -97px; top: 109px">
                    ...
                    <DisplayLayout AllowColSizingDefault="Free" BorderCollapseDefault="Separate"
                        ...
                        Name="grdDivisions" NoDataMessage="No Households found" RowHeightDefault="20px" RowSelectorsDefault="No"
                        ScrollBarView="Vertical" SelectTypeRowDefault="Single"
                        StationaryMarginsOutlookGroupBy="True"
                        Version="4.00" StationaryMargins="Header" TableLayout="Fixed">
                        <GroupByBox>
