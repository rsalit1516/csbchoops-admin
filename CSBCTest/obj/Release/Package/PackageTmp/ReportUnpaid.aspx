<%@ Page Language="VB" MasterPageFile="~/CSBCAdminMasterPage.master" AutoEventWireup="false" CodeFile="ReportUnpaid.aspx.vb" Inherits="ReportUnpaid" title="Unpaid Reports" %>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White"></BorderDetails>
            ...
            <td style="width: 107px; height: 26px" align="center">
                <asp:Button ID="btnPreDraft" runat="server" Text="Pre Draft" Width="104px" /></td>
        </tr>
        <tr>
            <td align="center" style="width: 107px; height: 26px">
            </td>
            <td style="width: 107px; height: 26px" align="center">
                <asp:Button ID="btnPostDraft" runat="server" Text="Post Draft" Width="104px" /></td>
        </tr>
        <tr>
