<%@ Page Language="VB" MasterPageFile="~/CSBCAdminMasterPage.master" AutoEventWireup="false" CodeFile="ReportVolunteers.aspx.vb" Inherits="ReportVolunteers" title="Volunteers Reports" %>
    ...
    <table style="width: 765px; height: 198px">
        <tr>
            <td align="center" rowspan="9" colspan="2" valign="top">
                &nbsp;<igtbl:UltraWebGrid ID="grdVolunteers" runat="server" Height="309px" Width="397px" style="left: -97px; top: 109px">
                    <Bands>
                        <igtbl:UltraGridBand>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White"></BorderDetails>
            ...
            <td style="width: 107px; height: 26px" align="center">
                <asp:Button ID="btnAll" runat="server" Text="All Seasons" Width="104px" /></td>
        </tr>
        <tr>
            <td align="center" style="width: 107px; height: 26px">
            </td>
            <td style="width: 107px; height: 26px" align="center"><asp:Button ID="btnCurrent" runat="server" Text="Current Season" Width="104px" /></td>
        </tr>
        <tr>
