<%@ Page Language="VB" MasterPageFile="~/CSBCAdminMasterPage.master" AutoEventWireup="false" CodeFile="SearchSponsor.aspx.vb" Inherits="SearchSponsor" title="Search Sponsors" %>
    ...
    <table style="width: 765px; height: 198px">
        <tr>
            <td align="center" colspan="3" style="height: 26px">
                <igtbl:UltraWebGrid ID="grdSponsors" runat="server" Height="355px" Width="755px">
                    <Bands>
                        <igtbl:UltraGridBand>
                    ...
                    <DisplayLayout AllowColSizingDefault="Free" AllowSortingDefault="OnClient" BorderCollapseDefault="Separate"
                        ...
                        Name="grdSponsors" NoDataMessage="No Sponsors found" RowHeightDefault="20px" RowSelectorsDefault="No"
                        ...
                        <FrameStyle BackColor="Window" BorderColor="Navy" BorderStyle="None" BorderWidth="1px"
                            Font-Names="Arial" Font-Size="9pt" Height="355px" Width="755px">
                        </FrameStyle>
                        <Pager>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White"></BorderDetails>
        ...
        <tr>
            <td align="left" rowspan="1" style="width: 223px">
                <asp:Label ID="lblName" runat="server" Font-Bold="True" Text="Sponsor Name" Width="120px"></asp:Label></td>
            <td align="left" style="width: 270px; height: 26px">
                &nbsp;</td>
            <td style="width: 107px; height: 26px">
        ...
        <tr>
            <td align="left" rowspan="1" style="width: 223px" valign="top" bordercolor="#000000">
                &nbsp;</td>
