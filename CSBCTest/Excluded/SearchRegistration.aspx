<%@ Page Language="VB" MasterPageFile="~/CSBCAdminMasterPage.master" AutoEventWireup="false" CodeFile="SearchRegistration.aspx.vb" Inherits="SearchRegistration" title="Registration/Payments" %>
    ...
    <table style="width: 371px; height: 123px">
        <tr>
            <td align="left" colspan="5">
                <igtbl:UltraWebGrid ID="grdRegistrations" runat="server" CaptionAlign="Left" DisplayLayout-FixedColumnScrollType="Pixel"
                    ...
                    <DisplayLayout AllowColSizingDefault="Free" AllowSortingDefault="OnClient" BorderCollapseDefault="Separate"
                        ...
                        HeaderTitleModeDefault="Never" Name="grdRegistrations" RowHeightDefault="20px" RowSelectorsDefault="No"
                        ScrollBarView="Vertical" SelectTypeRowDefault="Single" Version="4.00" NoDataMessage="No Seasons Data Found" ScrollBar="Always" TableLayout="Fixed" StationaryMargins="Header">
                        <GroupByBox>
