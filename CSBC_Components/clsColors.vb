...
Namespace CSBC.Components.Website
    Public Class ClsColors
        ...
        Public Function LoadColors(ByVal ColorId As Long, ByVal CompanyID As Int32, ByVal TeamID As Int32, ByVal DivisionID As Int32) As DataTable
            Dim DB As New ClsDatabase
            Try
                sSQL = " exec GetColors "
                sSQL += " @CompanyID = " & CompanyID
                sSQL += ", @colorID = " & ColorId
                sSQL += ", @TeamID = " & TeamID
